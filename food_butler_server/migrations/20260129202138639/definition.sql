...
--
-- Class CuratedMap as table curated_maps
--
...
--
-- Class DailyStory as table daily_stories
--
...
--
-- Class FavoriteCity as table favorite_cities
--
...
--
-- Class JournalPhoto as table journal_photos
--
...
--
-- Class MapRestaurant as table map_restaurants
--
...
--
-- Class ReservationClickEvent as table reservation_click_events
--
...
--
-- Class SavedRestaurant as table saved_restaurants
--
...
--
-- Class TonightPicksCache as table tonight_picks_cache
--
...
CREATE TABLE "tour_results" (
    ...
    "warningMessage" text,
    "tourTitle" text,
    "tourIntroduction" text,
    "tourVibe" text,
    "tourClosing" text,
    "curatedTourJson" text,
    "createdAt" timestamp without time zone NOT NULL
);
