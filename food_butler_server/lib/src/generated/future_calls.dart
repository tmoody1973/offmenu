...
import 'package:food_butler_server/src/generated/empty_data.dart' as _i2;
import 'dart:async' as _i3;
import '../future_calls/daily_story_generation_call.dart' as _i4;
...
class FutureCalls extends _i1.FutureCallDispatch<_FutureCallRef> {
  ...
  void initialize(
    ...
    var registeredFutureCalls = <String, _i1.FutureCall>{
      'DailyStoryGenerationCallInvokeFutureCall':
          DailyStoryGenerationCallInvokeFutureCall(),
    };
...
class _FutureCallRef {
  ...
  late final dailyStoryGenerationCall =
      _DailyStoryGenerationCallFutureCallDispatcher(_invokeFutureCall);
}

class _DailyStoryGenerationCallFutureCallDispatcher {
  _DailyStoryGenerationCallFutureCallDispatcher(this._invokeFutureCall);

  final _InvokeFutureCall _invokeFutureCall;

  Future<void> invoke(_i2.EmptyData? object) {
...
class DailyStoryGenerationCallInvokeFutureCall
    extends _i1.FutureCall<_i2.EmptyData> {
  @override
  _i3.Future<void> invoke(
    _i1.Session session,
    _i2.EmptyData? object,
  ) async {
    await _i4.DailyStoryGenerationCall().invoke(
      session,
      object,
    );
  }
